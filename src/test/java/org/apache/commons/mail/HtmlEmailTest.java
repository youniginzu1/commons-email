...
// this.email.setSubject(strSubject);
// this.email.setMsg("Test txt msg ä"); // add non-ascii character, otherwise
...
// final String strSubject = "A dot (\".\") is appended to some ULRs of a HTML
// mail.";
// this.email.setSubject(strSubject);
...
// assertNotNull(strEmbed);
// assertEquals("didn't get same CID when embedding with a specified CID",
// encodedCid, strEmbed);
...
// private void assertCorrectContentType(final String picture, final String
// contentType) throws Exception {
// final HtmlEmail htmlEmail = createDefaultHtmlEmail();
// final String cid = htmlEmail.embed(new File("./src/test/resources/images/" +
// picture), "Apache Logo");
